...
var blogs = [
  {
    ...
    title: "Week 6", 
    theme: "ES6 is better.",
    content: "We were introduced to the syntax of ES6, which makes certain things less tedious. I have a grasp of the differences between 'var', 'let', and 'const' and understand that 'let' will be used most of the time. I read an article here https://hackernoon.com/getting-to-grips-with-es6-variables-f27b72798bf3 that elaborates on the differences. Basically, the three variable types vary in that 'var' allows you to define, update, and redefine the value; 'let' allows you to define and update, and 'const' allows you to define (only). 'Let' and 'const' were developed because 'var' is a little dangerous, being globally scoped if defined outside a variable, resulting in 'naming collisions'. I understand these differences in theory, but also understand that in order to really understand, I'll have to become more familiar with using them. Template literals seem more efficient and easier on the eye and so does the fat arrow function. I'll sign off with once concern, however. I wonder how the arrow feels about being called fat'?"
    },
    {
    id: "blog7", 
    title: "Week 7", 
