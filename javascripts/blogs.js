...
var blogs = [
  {
    ...
    content: "Everything was peaceful until my team came to a bump in the road (Wizard of Oz reference spared, but just this once). We decided that I should determine the style of our website--for a hypothetical metal band called The Frog Sayeth Croak. Styling for this project was not a priority (or, MVP--Minimum Viable Product), as the goal was to practice GitHub workflow and JavaScript looping and functions. The directions explained that we would receive bonus points for a site that looked like an old-school MySpace page. FUN!!! My vision was to achieve deliberate mediocrity--something tacky that had the imprint of a newbie coder--maybe a fan of the band. It made sense to me as newbies ourselves, and we were not using any frameworks or libraries. I began the style guide with 'murky, green, dark (swampy--this band has 'frog' in their name), kitschy, and sorta bad taste'.  I set neon green to outline images upon hover (only slightly obnoxious) and coded a putrid rust color to glow behind some text. And how about a Halloweeny Google font called 'Eater' for headers and leaving tacky bullets on lists. SLICK!!! Everything would be set on a grey-to-green gradient background. Bloated with satisfaction, I shared it with the group. The first reaction from a teammate was 'METAL'. The second was not so accepting. A bit deflated, I realized we hadn't discussed in depth the character of the band and how that would be expressed. The dissenting teammate explained that regardless of whether 'tacky' is deliberately 'tacky' or unintentionlly so, it is still just 'tacky' and that we couldn't do it this way because the project would be going into our portfolios. Wait! Not true! These early team projects aren't meant to be portfolio material. They are places to make mistakes and learn. I admit I was disappointed that my aesthetic was not appreciated. I knew we all needed to discuss the theme further and come up with something mutually agreed upon. A couple teammates created their ideas and we organically ended up blending elements of each. The site did not end up having the purity of garishness that I had hoped for but it still looked pretty good."
    },
    {
    id: "blog6", 
    title: "Week 6", 
